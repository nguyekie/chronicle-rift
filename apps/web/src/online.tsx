...
export function EventHub() {
  ...
  if(battleStage)return <div className="event-battle"><BattleWithDeckSelection title={battleStage===12?'Chúa Tể Nhật Thực':`Khe Nhật Thực ${battleStage}`} onComplete={()=>complete(battleStage)} onBack={()=>setBattleStage(undefined)}/></div>;
