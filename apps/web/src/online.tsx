...
export function EventHub() {
  ...
  if(battleStage)return <div className="event-battle"><button className="event-back" onClick={()=>setBattleStage(undefined)}>← Trở lại sự kiện</button><LocalBattle title={battleStage===12?'Chúa Tể Nhật Thực':`Khe Nhật Thực ${battleStage}`} onComplete={()=>complete(battleStage)}/></div>;
